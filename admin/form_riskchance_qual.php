...
if(isset($_REQUEST['code'])) {
	...
	$title		= 'เพิ่มข้อมูลโอกาสเกิดความเสี่ยงเชิงคุณภาพ';
}

// find plan
date_default_timezone_set("Asia/Bangkok");
$year 	= date('Y');
$sql = "SELECT IDplan, planName FROM plan where y_insert = '$year' AND riskchance_type = 'qual'";
$result = mysql_query($sql, $dbConn);
...
if($rowsPlan <= 0) {
	?>
	<font color="red">ไม่พบแผนงานที่มีโอกาสเกิดความเสี่ยงแบบเชิงคุณภาพ</font><br><br>
	<a href="show_riskchance_qual.php">ย้อนกลับ</a>
	<?php
} else {
?>
<form id="form-table" name="form-table" action="manage_riskchance_qual.php">
    ...
    <a href="show_riskchance_qual.php" class="btn">
