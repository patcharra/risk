...
$query		= "select mean from  level_and_meanO where levelO =".$id; 
...
<br>
<h3>แก้ไขระดับของโอกาสจะเกิดความเสี่ยง</h3><br><br>
<table>
...
$id	= $_REQUEST["id"];
			...
			$sql = "Update $tblname Set mean ='".$_POST["mean"]."' Where levelO ='$id'";
